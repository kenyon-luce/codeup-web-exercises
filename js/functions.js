...
var x = prompt("How much are you paying for your meal in total?");
var y = prompt("How much percentage are you willing to leave as a tip?");
var tip = "$" + calculateTip(x,y);
alert("You should leave a " + tip + " tip!" );
