...
console.log("Hey, y'all! I own a " + myCar["make"] + " " + myCar.model) //Should concat from these two properties (dot and array notation) into this structure like we've been used to doing with variables
...
// console.log("Whoops - forgot to tell you what year my vehicle is, it's model year " + myCarYear)
console.log("Whoops - forgot to tell you what year my vehicle is, it's model year " + myCarYear);
...
myCar.features = ["ventilated seats", "parking cam", "charging station", "collapsable side mirrors"]
...
//ran turnOn function for each object in theGarage
