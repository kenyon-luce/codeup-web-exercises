...
function threeMostRecentPies(array) {
    return array.slice(3);
}
console.log("Just baked " + piesWithExtraPie.length + " pies total: " + piesWithExtraPie);
console.log("Most recent are: " + threeMostRecentPies(piesWithExtraPie));
...
*/
var phoneNumbers = '210-555-2020\n230-555-2020\n512-555-3030';
function cleanPhoneNum(phoneNums) {
    var output = [];
    var phoneNumArr = phoneNums.split("\n");
    phoneNumArr.forEach(function(phoneNum){
        var phoneNumArr = phoneNum.split("-");
        output.push(phoneNumArr.join(""));
    });
    return output;
}
//doesn't seem to work
console.log(cleanPhoneNum(phoneNumbers));
